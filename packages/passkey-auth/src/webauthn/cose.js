 ...
 * Get COSE key type
 *
 * @param {import("./types").COSEPublicKey} key
 */
    ...
    case 'EC2': {
      ...
      return DID.format(
        DID.decode(
          ...
          concat([P256_DID_PREFIX, compressP256Pubkey(buf)])
        )
      )
    }
    case 'OKP': {
 ...
 * @param {import('./cose').COSEALG} alg - Cose alg, defaults to -7 (ES256) SHA-256 for web crypto
 */

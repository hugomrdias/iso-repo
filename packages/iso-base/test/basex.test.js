...
const alphabets = {
  ...
  base45: '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:', // note: includes space
  base58: '123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz',
}

/**
 * Valid test vectors from base-x npm package
 * @type {Array<{alphabet: string, hex: string, string: string, comment?: string}>}
 */
const valid = [
  { alphabet: 'base2', hex: '000f', string: '01111' },
  {
    alphabet: 'base2',
    hex: '00ff',
  ...
  { alphabet: 'base2', hex: '0fff', string: '111111111111' },
  {
    alphabet: 'base2',
    hex: 'ff00ff00',
    string: '11111111000000001111111100000000',
  },
  { alphabet: 'base16', hex: '0000000f', string: '000f' },
  { alphabet: 'base16', hex: '000fff', string: '0fff' },
  { alphabet: 'base16', hex: 'ffff', string: 'ffff' },
  { alphabet: 'base58', hex: '', string: '' },
  { alphabet: 'base58', hex: '61', string: '2g' },
  { alphabet: 'base58', hex: '626262', string: 'a3gV' },
  { alphabet: 'base58', hex: '636363', string: 'aPEr' },
  {
    alphabet: 'base58',
  ...
  { alphabet: 'base58', hex: '516b6fcd0f', string: 'ABnLTmg' },
  { alphabet: 'base58', hex: 'bf4f89001e670274dd', string: '3SEo3LWLoPntC' },
  { alphabet: 'base58', hex: '572e4794', string: '3EFU7m' },
  { alphabet: 'base58', hex: 'ecac89cad93923c02321', string: 'EJDM8drfXA6uyA' },
  { alphabet: 'base58', hex: '10c8511e', string: 'Rt5zm' },
  { alphabet: 'base58', hex: '00000000000000000000', string: '1111111111' },
  {
    alphabet: 'base58',
  ...
  { alphabet: 'base58', hex: 'ffffffffffffffffffff', string: 'FPBt6CHo3fovdL' },
  {
    alphabet: 'base58',
  ...
  { alphabet: 'base58', hex: 'ef41b9ce7e830af7', string: 'h26E62FyLQN' },
  { alphabet: 'base58', hex: '606cbc791036d2e9', string: 'H8Sa62HVULG' },
  { alphabet: 'base58', hex: 'bdcb0ea69c2c8ec8', string: 'YkESUPpnfoD' },
  { alphabet: 'base58', hex: '1a2358ba67fb71d5', string: '5NaBN89ajtQ' },
  { alphabet: 'base58', hex: 'e6173f0f4d5fb5d7', string: 'fVAoezT1ZkS' },
  { alphabet: 'base58', hex: '91c81cbfdd58bbd2', string: 'RPGNSU3bqTX' },
  { alphabet: 'base58', hex: '329e0bf0e388dbfe', string: '9U41ZkwwysT' },
  { alphabet: 'base58', hex: '30b10393210fa65b', string: '99NMW3WHjjY' },
  { alphabet: 'base58', hex: 'ab3bdd18e3623654', string: 'VeBbqBb4rCT' },
  { alphabet: 'base58', hex: 'fe29d1751ec4af8a', string: 'jWhmYLN9dUm' },
  { alphabet: 'base58', hex: 'c1273ab5488769807d', string: '3Tbh4kL3WKW6g' },
  { alphabet: 'base58', hex: '6c7907904de934f852', string: '2P5jNYhfpTJxy' },
  { alphabet: 'base58', hex: '05f0be055db47a0dc9', string: '5PN768Kr5oEp' },
  { alphabet: 'base58', hex: '3511e6206829b35b12', string: 'gBREojGaJ6DF' },
  { alphabet: 'base58', hex: 'd1c7c2ddc4a459d503', string: '3fsekq5Esq2KC' },
  { alphabet: 'base58', hex: '1f88efd17ab073e9a1', string: 'QHJbmW9ZY7jn' },
  { alphabet: 'base58', hex: '0f45dadf4e64c5d5c2', string: 'CGyVUMmCKLRf' },
  { alphabet: 'base58', hex: 'de1e5c5f718bb7fafa', string: '3pyy8U7w3KUa5' },
  { alphabet: 'base58', hex: '123190b93e9a49a46c', string: 'ES3DeFrG1zbd' },
  { alphabet: 'base58', hex: '8bee94a543e7242e5a', string: '2nJnuWyLpGf6y' },
  { alphabet: 'base58', hex: '9fd5f2285362f5cfd834', string: '9yqFhqeewcW3pF' },
  { alphabet: 'base58', hex: '6987bac63ad23828bb31', string: '6vskE5Y1LhS3U4' },
  { alphabet: 'base58', hex: '19d4a0f9d459cc2a08b0', string: '2TAsHPuaLhh5Aw' },
  { alphabet: 'base58', hex: 'a1e47ffdbea5a807ab26', string: 'A6XzPgSUJDf1W5' },
  { alphabet: 'base58', hex: '35c231e5b3a86a9b83db', string: '42B8reRwPAAoAa' },
  { alphabet: 'base58', hex: 'b2351012a48b8347c351', string: 'B1hPyomGx4Vhqa' },
  { alphabet: 'base58', hex: '71d402694dd9517ea653', string: '7Pv2SyAQx2Upu8' },
  { alphabet: 'base58', hex: '55227c0ec7955c2bd6e8', string: '5nR64BkskyjHMq' },
  { alphabet: 'base58', hex: '17b3d8ee7907c1be34df', string: '2LEg7TxosoxTGS' },
  { alphabet: 'base58', hex: '7e7bba7b68bb8e95827f', string: '879o2ATGnmYyAW' },
  {
    alphabet: 'base58',
 ...
 * @type {Array<{alphabet: string, description: string, exception: string, string?: unknown}>}
 */
const invalid = [
  {
    alphabet: 'base58',
  ...
  },
  {
    alphabet: 'base58',
    description:
      'character whose code exceeds the highest index of base map (>=256)',
    exception: '^Error: Non-base58 character$',
    string: '\u1000',
  },
]
...
describe('basex', () => {
  describe('encode', () => {
    for (const fixture of valid) {
      ...
      it(`should encode ${fixture.hex || '(empty)'} to "${fixture.string}" (${fixture.alphabet})`, () => {
        const codec = base(alphabet)
        const result = codec.encode(bytes)
        assert.strictEqual(result, fixture.string)
      })
    }
  })
  ...
  describe('decode', () => {
    for (const fixture of valid) {
      const alphabet = alphabets[fixture.alphabet] ?? fixture.alphabet
      const expectedBytes = hexToBytes(fixture.hex)

      it(`should decode "${fixture.string}" to ${fixture.hex || '(empty)'} (${fixture.alphabet})`, () => {
        const codec = base(alphabet)
        const result = codec.decode(fixture.string)
        assert.strictEqual(bytesToHex(result), fixture.hex)
        assert.deepStrictEqual(result, expectedBytes)
      })
    }
  })
  ...
  describe('decodeUnsafe', () => {
    it('should return undefined for invalid characters', () => {
      ...
      assert.strictEqual(codec.decodeUnsafe('#####'), undefined)
      assert.strictEqual(codec.decodeUnsafe('invalid'), undefined)
      assert.strictEqual(codec.decodeUnsafe('c2F0b3NoaQo='), undefined)
    })

    it('should return Uint8Array for valid input', () => {
      const codec = base(alphabets.base58)
      const result = codec.decodeUnsafe('2g')
      assert.ok(result instanceof Uint8Array)
      assert.strictEqual(bytesToHex(result), '61')
    })
  })
  ...
  describe('roundtrip', () => {
    const sizes = [0, 1, 8, 16, 32, 64, 128, 256, 512, 1024]

    for (const size of sizes) {
      it(`should roundtrip random ${size} bytes (base58)`, () => {
        const codec = base(alphabets.base58)
    ...
    it('should handle leading zeros correctly', () => {
      ...
      assert.deepStrictEqual(decoded, bytes)
      assert.ok(encoded.startsWith('111')) // Three leading '1's
    })
    ...
    it('should handle all zeros', () => {
      ...
      assert.strictEqual(encoded, '11111')
      assert.deepStrictEqual(decoded, bytes)
    })
  ...
  describe('input types', () => {
    ...
    it('should accept ArrayBuffer views', () => {
      ...
      assert.strictEqual(codec.encode(uint8View), 'Ldp')
    })

    it('should throw for non-array inputs', () => {
      const codec = base(alphabets.base58)
      assert.throws(() => codec.encode(/** @type {any} */ ('string')))
      assert.throws(() => codec.encode(/** @type {any} */ (123)))
      assert.throws(() => codec.encode(/** @type {any} */ (null)))
    })
  })
})
